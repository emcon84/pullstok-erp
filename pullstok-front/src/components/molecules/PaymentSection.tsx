 ...
 * R10): selector de método, efectivo recibido, agregar pago del saldo restante,
 * desglose de payments con "Total pagado" y "Limpiar". Reutilizada por el POS
 * (VendorCartSheet), el SalesDrawer y las ventas directas. Stateless: recibe
 * todo por props, la lógica vive en usePayments.
 */
