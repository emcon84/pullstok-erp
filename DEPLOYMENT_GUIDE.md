# Guía de Deployment - Nexo en VPS Hostinger

Esta guía te ayudará a migrar tu aplicación Nexo (Frontend + API) a tu VPS en Hostinger.
...
¡Listo! Tu aplicación Nexo debería estar corriendo en tu VPS de Hostinger. 🎉
