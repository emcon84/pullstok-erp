...
/**
 * Lógica reusable de import CSV de productos (extraída de
 * ModalContentUploadCsv para reusarla también en StepProducts del wizard de
 * onboarding, sin duplicar el flujo de subida).
 */
export const ProductCsvUploadForm = ({
  onSuccess,
  ...
  const handleUpload = () => {
    if (file) submitUpload(file, { onSuccess });
  };
